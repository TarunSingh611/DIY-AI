...
export default function TravelPlannerPage() {
  ...
  const handleSubmit = async (values: any, { setSubmitting }: any) => {
    ...
    setFormData(values); // Store the user's form data
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      <Head>
        <title>Travel Planner - DIY_AI</title>
      ...
      <main>
        ...
        <section className="pt-8 pb-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <Link
              href="/"
              className="flex items-center gap-2 text-slate-600 hover:text-slate-800 transition-colors duration-200 mb-4 inline-block"
            >
        ...
        <section className="py-8 lg:py-12">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold text-slate-400 mb-6">
                AI Travel Planner
              </h1>
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Plan your perfect trip with AI-powered travel planning. Get personalized itineraries, 
                recommendations, and travel tips tailored to your preferences.
              </p>
            </div>
          </div>
        </section>
          ...
          <section id="trip-results" className="py-16 lg:py-24 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="max-w-6xl mx-auto">
                <TripDetails loading={loading} tripPlan={tripPlan} formData={formData} />
              </div>
            </div>
          </section>
        )}
